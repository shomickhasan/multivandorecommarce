                    ...
                    <aside class="sidebar_section p-0 mt-0">
                        <div class="sb_widget sb_category">
                            ...
                            <ul class="sb_category_list ul_li_block">
                                <li>
                                    <a> {{$categoryName->category_name}}<span></span></a>
                                </li>
                    ...
                    <div class="filter_topbar">
                        <div class="row align-items-center">
                            ...
                            <div class="col col-md-3 text-md-end">
                                <div class="result_text text-md-end">Showing {{$products->count()}} of {{$totalproductsCount}} relults</div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="product-area-row">
                                    ...
                                    <div class="grid clearfix">
                                        ...
                                        <div class="details">
                                            ...
                                            <p><a href="#">{{$product->short_desc}}</a></p>
                                            <div class="rating">
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>
                                                <i class="fas fa-star"></i>

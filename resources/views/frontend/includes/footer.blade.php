                ...
                <div class="col col-lg-4 col-md-6 col-sm-6">
                    <div class="footer_widget footer_about">
                        ...
                        <ul class="social_round ul_li">
                            <li><a target="_blank" href="https://{{$setting->youtube_link}}"><i class="icofont-youtube-play"></i></a></li>
                            <li><a target="_blank" href="https://{{$setting->instagram_link}}"><i class="icofont-instagram"></i></a></li>
                            <li><a target="_blank" href="https://{{$setting->twitter_link}}"><i class="icofont-twitter"></i></a></li>
                            <li><a target="_blank" href="https://{{$setting->facebook_link}}"><i class="icofont-facebook"></i></a></li>
                            <li><a target="_blank" href="https://{{$setting->linkedin_link}}"><i class="icofont-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>

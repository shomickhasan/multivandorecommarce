            ...
            <div class="row justify-content-center h-100">
                    ...
                    <div class="card mb-sm-3 mb-md-0 contacts_card">
                        ...
                        <div class="card-body contacts_body">
                            {{-- @foreach ($users as $user)
                                <input type="hidden" class="name" value="{{ $user->user->name }}">
                                <input type="hidden" class="userId" value="{{ $user->user->id }}">
                            @endforeach --}}
                            <ul class="contacts">
                                @foreach ($users as $user)
                                    <li class="active" value="{{ $user->user->id }}">
                ...
                <div class="col-md-8 col-xl-6 chat">
                    <div class="card">
                        ...
                        <li class="user_id d-none"></li>
                        <li class="vendor_id d-none"></li>
                        <li class="product_id d-none"></li>
                        <input class="status" type="hidden" name="status" placeholder="User Id" value="2">
                        ...
                        <div class="card-footer msg_footer">
                            {{-- <div class="input-group">
